...
func DefaultPlaylistColumns(width int) []table.Column {
	// Fixed column widths
...
func NewPlaylist(columns []table.Column, rows []table.Row) table.Model {
	...
	t.SetStyles(DefaultPlaylistStyles())
	return t
}

func DefaultPlaylistStyles() table.Styles {
